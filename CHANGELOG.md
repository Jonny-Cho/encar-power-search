...
## [1.1.0] - 2025-08-21
### 🆕 새로운 기능
- **기본 500개 페이지로 설정** 기능 추가
  - 사용자 설정에 따라 기본 페이지 표시 개수를 500개로 자동 설정
  - 팝업에서 기본값 설정 토글 제어 가능
  
### 🔧 개선
- 페이지로우 확장 모듈 리팩토링으로 안정성 향상
- 설정 서비스 확장으로 더 많은 사용자 선호도 관리
- 팝업 UI 간소화 및 사용성 개선

### 📱 사용자 경험
- 매번 페이지 개수를 변경할 필요 없이 기본값으로 설정 가능
- 더 나은 검색 경험을 위한 대량 리스트 기본 제공
